...
object Attributes {
	...
	val FLAG_GOOD = create("LIBGLOCAL_FLAG", D.KEYWORD)
	val FLAG_BAD = create("LIBGLOCAL_FLAG", D.INVALID_STRING_ESCAPE)
	...
	fun tokenMap(tokenType: IElementType?): TextAttributesKey? = when (tokenType) {
		...
		E.T_FLAG_PUBLIC -> FLAG_GOOD
		E.T_FLAG_LIB -> FLAG_GOOD
		E.T_FLAG_LOCAL -> FLAG_GOOD
		E.T_FLAG_LIST -> FLAG_GOOD
		E.T_FLAG_UNKNOWN -> FLAG_BAD
