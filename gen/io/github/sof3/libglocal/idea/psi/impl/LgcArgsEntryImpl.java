...
public class LgcArgsEntryImpl extends ASTWrapperPsiElement implements LgcArgsEntry {

  public LgcArgsEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitArgsEntry(this);
  }
