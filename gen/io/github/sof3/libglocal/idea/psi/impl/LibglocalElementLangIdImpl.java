...
public class LibglocalElementLangIdImpl extends ASTWrapperPsiElement implements LibglocalElementLangId {

  public LibglocalElementLangIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementLangId(this);
  }
