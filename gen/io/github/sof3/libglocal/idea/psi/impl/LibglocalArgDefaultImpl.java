...
public class LibglocalArgDefaultImpl extends ASTWrapperPsiElement implements LibglocalArgDefault {

  public LibglocalArgDefaultImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitArgDefault(this);
  }
