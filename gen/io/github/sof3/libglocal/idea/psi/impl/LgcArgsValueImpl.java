...
public class LgcArgsValueImpl extends ASTWrapperPsiElement implements LgcArgsValue {

  public LgcArgsValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitArgsValue(this);
  }
