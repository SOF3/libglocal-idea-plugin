...
public class LgcDelimConstraintImpl extends ASTWrapperPsiElement implements LgcDelimConstraint {

  public LgcDelimConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitDelimConstraint(this);
  }
