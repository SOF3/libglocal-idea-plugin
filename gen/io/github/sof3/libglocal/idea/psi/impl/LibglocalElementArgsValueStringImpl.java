...
public class LibglocalElementArgsValueStringImpl extends ASTWrapperPsiElement implements LibglocalElementArgsValueString {

  public LibglocalElementArgsValueStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementArgsValueString(this);
  }
