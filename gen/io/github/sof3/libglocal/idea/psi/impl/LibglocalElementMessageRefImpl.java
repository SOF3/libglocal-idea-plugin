...
public class LibglocalElementMessageRefImpl extends ASTWrapperPsiElement implements LibglocalElementMessageRef {

  public LibglocalElementMessageRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementMessageRef(this);
  }
