...
public class LibglocalElementLiteralStaticImpl extends ASTWrapperPsiElement implements LibglocalElementLiteralStatic {

  public LibglocalElementLiteralStaticImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementLiteralStatic(this);
  }
