...
public class LgcLiteralStaticImpl extends ASTWrapperPsiElement implements LgcLiteralStatic {

  public LgcLiteralStaticImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitLiteralStatic(this);
  }
