...
public class LibglocalElementArgRefImpl extends ASTWrapperPsiElement implements LibglocalElementArgRef {

  public LibglocalElementArgRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementArgRef(this);
  }
