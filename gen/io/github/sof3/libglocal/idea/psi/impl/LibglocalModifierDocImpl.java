...
public class LibglocalModifierDocImpl extends ASTWrapperPsiElement implements LibglocalModifierDoc {

  public LibglocalModifierDocImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitModifierDoc(this);
  }
