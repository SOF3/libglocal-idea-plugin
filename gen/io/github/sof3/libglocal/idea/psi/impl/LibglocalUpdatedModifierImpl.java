...
public class LibglocalUpdatedModifierImpl extends ASTWrapperPsiElement implements LibglocalUpdatedModifier {

  public LibglocalUpdatedModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitUpdatedModifier(this);
  }
