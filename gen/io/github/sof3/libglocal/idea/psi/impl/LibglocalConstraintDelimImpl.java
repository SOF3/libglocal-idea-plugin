...
public class LibglocalConstraintDelimImpl extends ASTWrapperPsiElement implements LibglocalConstraintDelim {

  public LibglocalConstraintDelimImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitConstraintDelim(this);
  }
