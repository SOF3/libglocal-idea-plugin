...
public class LibglocalElementArgTypeImpl extends ASTWrapperPsiElement implements LibglocalElementArgType {

  public LibglocalElementArgTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitElementArgType(this);
  }
