...
public class LgcArgsValueStringImpl extends ASTWrapperPsiElement implements LgcArgsValueString {

  public LgcArgsValueStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitArgsValueString(this);
  }
