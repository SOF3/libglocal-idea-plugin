...
public class LibglocalArgModifierImpl extends ASTWrapperPsiElement implements LibglocalArgModifier {

  public LibglocalArgModifierImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public LibglocalArgDefault getArgDefault() {
    return findChildByClass(LibglocalArgDefault.class);
  }
