...
public class LibglocalMessageEntryImpl extends ASTWrapperPsiElement implements LibglocalMessageEntry {

  public LibglocalMessageEntryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitMessageEntry(this);
  }
