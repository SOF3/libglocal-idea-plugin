...
public class LgcDocConstraintImpl extends ASTWrapperPsiElement implements LgcDocConstraint {

  public LgcDocConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitDocConstraint(this);
  }
