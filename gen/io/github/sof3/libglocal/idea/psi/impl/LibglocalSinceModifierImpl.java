...
public class LibglocalSinceModifierImpl extends ASTWrapperPsiElement implements LibglocalSinceModifier {

  public LibglocalSinceModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitSinceModifier(this);
  }
