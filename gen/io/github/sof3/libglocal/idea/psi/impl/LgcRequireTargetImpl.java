...
public class LgcRequireTargetImpl extends ASTWrapperPsiElement implements LgcRequireTarget {

  public LgcRequireTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitRequireTarget(this);
  }
