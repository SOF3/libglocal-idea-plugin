...
public class LibglocalElementSpanImpl extends ASTWrapperPsiElement implements LibglocalElementSpan {

  public LibglocalElementSpanImpl(@NotNull ASTNode node) {
    super(node);
  }
