...
public class LibglocalMessageHeaderImpl extends ASTWrapperPsiElement implements LibglocalMessageHeader {

  public LibglocalMessageHeaderImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitMessageHeader(this);
  }
