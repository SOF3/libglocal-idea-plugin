...
public class LibglocalArgRefImpl extends ASTWrapperPsiElement implements LibglocalArgRef {

  public LibglocalArgRefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitArgRef(this);
  }
