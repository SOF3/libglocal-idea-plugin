...
public class LibglocalLangTypeImpl extends ASTWrapperPsiElement implements LibglocalLangType {

  public LibglocalLangTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LibglocalVisitor visitor) {
    visitor.visitLangType(this);
  }
